  ...
  return (
    <>
      ...
      >
        ...
        {/* Instagram link */}
        <div className="px-5 py-3 border-t flex items-center gap-2.5" style={{ borderColor: 'rgba(223,207,134,0.1)' }}>
          <a
            href={INSTAGRAM_URL}
            target="_blank"
            rel="noopener noreferrer"
            onClick={() => setMenuOpen(false)}
            className="flex items-center gap-2 font-sans text-sm text-white/65 hover:text-brand-gold transition-colors"
          >
