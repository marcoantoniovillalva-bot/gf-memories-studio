    ...
    >
      ...
      >
        ...
        <div className="flex flex-col items-center gap-1.5">
          ...
          <div className="flex flex-row gap-2 w-full max-w-[280px] mt-1">
            <a
              href="https://wa.link/yflhc8"
              target="_blank" rel="noopener noreferrer"
              className="flex-1 flex items-center justify-center gap-1.5 py-2.5 font-sans font-bold uppercase tracking-[0.13em] rounded-full btn-luxury-gold"
              style={{ fontSize: '9px', background: '#DFCF86', color: '#3d5568' }}
            >
            ...
            <a
              href="#servizi"
              className="flex-1 flex items-center justify-center gap-1.5 py-2.5 font-sans font-medium uppercase tracking-[0.13em] rounded-full border btn-luxury-outline"
              style={{ fontSize: '9px', borderColor: 'rgba(81,113,138,0.35)', color: '#51718A' }}
            >
              Servizi
